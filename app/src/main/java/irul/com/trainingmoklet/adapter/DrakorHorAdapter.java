...
public class DrakorHorAdapter extends RecyclerView.Adapter<DrakorHorAdapter.ViewHolder> {

    //ArrayList<Drakor> drakorList;
    ArrayList<Meal> mealList;


    public DrakorHorAdapter(ArrayList<Meal> mealList) {
        this.mealList = mealList;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.drakor_hor_list, parent, false);
